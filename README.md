...
1. 해결한 문제나 학습 내용에 대한 대화 기록을 준비합니다
2. 아래 **시스템 프롬프트 전문**을 LLM 시스템 프롬프트 또는 첫 메시지로 전달합니다
3. 대화 기록을 붙여넣고 다음과 같이 요청합니다:

```
지금까지 나눈 대화 기록을 바탕으로 내가 어떤 문제를 해결했고,
여기서 사용된 기술 스택 혹은 얻을만한 insight 등을 정리해서 기록해줘.
README를 참고해서 양식을 준수해서 작성해줘.
```
